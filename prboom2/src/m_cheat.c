...
cheatseq_t cheat[] = {
  ...
  CHEAT("vm",         "Invincibility",    cht_never, cheat_megaarmour, 0),
  CHEAT("vv",         "Invincibility",    cht_never, cheat_pw, pw_invulnerability),
  CHEAT("vs",         "Berserk",          cht_never, cheat_pw, pw_strength),
  CHEAT("vi",         "Invisibility",     cht_never, cheat_pw, pw_invisibility),
  CHEAT("vr",         "Radiation Suit",   cht_never, cheat_pw, pw_ironfeet),
  CHEAT("va",         "Auto-map",         not_dm, cheat_pw, pw_allmap),
  CHEAT("vl",         "Lite-Amp Goggles", not_dm, cheat_pw, pw_infrared),
  CHEAT("v",          "BEHOLD menu",      not_dm, cheat_behold, 0),
  CHEAT("c",          "Level Warp",       cht_never | not_menu, cheat_clev, -2),
  CHEAT("c",          "Level Warp",       cht_never | not_menu, cheat_clev0, 0),
